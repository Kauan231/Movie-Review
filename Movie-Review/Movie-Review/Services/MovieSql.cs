...
namespace Movie_Review.Services
{
    ...
    {
        public static SearchResult RequestMovieByName(UserContext _context, string Movie_Name)
        {
        ...
        public static Movie RequestMovieById(UserContext _context, string IMDb_ID)
        {
